      ...
      <div class="row">
        ...
        <!-- <div class="col-md-6 col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text bg-white p-4">
              <h3 class="heading"><a href="#">Isra Mi'raj</a></h3>
        ...
        <div class="col-md-6 col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text bg-white p-4">
              <h3 class="heading"><a href="#">Lomba Olimpiade</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
                blind texts.</p>
              <div class="d-flex align-items-center mt-4">
                <p class="mb-0"><a href="#" class="btn btn-primary">Lanjut Baca <span
        ...
        <div class="col-md-6 col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text bg-white p-4">
              <h3 class="heading"><a href="#">Lomba Menari</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
                blind texts.</p>
              <div class="d-flex align-items-center mt-4">
                <p class="mb-0"><a href="#" class="btn btn-primary">Lanjut Baca <span
        ...
        <div class="col-md-6 col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text bg-white p-4">
              <h3 class="heading"><a href="#">Bermain Bola</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
                blind texts.</p>
              <div class="d-flex align-items-center mt-4">
                <p class="mb-0"><a href="#" class="btn btn-primary">Lanjut Baca <span
        ...
        <div class="col-md-6 col-lg-4 ftco-animate">
          <div class="blog-entry">
            ...
            <div class="text bg-white p-4">
              <h3 class="heading"><a href="#">Membersihkan Sekolah</a></h3>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the
                blind texts.</p>
              <div class="d-flex align-items-center mt-4">
                <p class="mb-0"><a href="#" class="btn btn-primary">Lanjut Baca <span
